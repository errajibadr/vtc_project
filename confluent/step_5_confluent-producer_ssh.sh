...
export AWSBASTIONHOST=<BASTION.IP>
export AWSCONFLUENTPRODUCERHOST=<PRODUCER.IP>

# ssh -i "~/repository/vtc_project/confluent/pem-ec2.pem" ec2-user@ec2-15-237-96-109.eu-west-3.compute.amazonaws.com

#Jump host
ssh -i "~/repository/vtc_project/confluent/pem-ec2.pem" -J ec2-user@$AWSBASTIONHOST ec2-user@$AWSCONFLUENTPRODUCERHOST -o ConnectTimeout=10
